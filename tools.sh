...
sleep 1
echo ""
echo -e $white"[#]> Mr. AxE Wuzz Here ... "
read enter
exit
}

# Isi oc : *
figlet Mr. AxE | lolcat
echo " "
echo -e  "_____________________________________________________________"
echo -e  "Tools       : Mr. AxE $white         "
echo -e  "Creadby  : Adikara830 $white   "
echo -e  "Follow Me In Github : Adikaranrm $white "
echo -e  "_____________________________________________________________"
echo " "
...
then
clear
echo -e $red" Installing Pybelt "then
sleep 1
